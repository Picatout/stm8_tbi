...
16 CONST OLED.PG.ADR=$22, DISP.START=$40, OLED.SEG.REMAP=$A0
...
78 GOSUB HELLO
80 GOSUB WAIT.KEY 
82 POKE CMD,DISP.SLEEP:GOSUB OLED.CMD 
83 COUNT=2:POKE CMD,OLED.CHARG.PUMP:POKE CMD+1,$10:GOSUB OLED.CMD 
84 I2C.CLOSE 
85 END  
...
216 POKE CMD,DISP.START :GOSUB OLED.CMD ' set display start line 
...
662 LET COUNT=3
664 POKE CMD,OLED.PG.ADR:POKE CMD+1,0:POKE TBUF+3,7:GOSUB OLED.CMD 
