...
50  LET EADR=0 , BUFF=PAD+4 
58  ' read 10 bytes 
60  LET COUNT=10 : GOSUB EE.READ 
70  ' print read values 
80  FOR I=BUFF TO I+COUNT-1 ? PEEK(I); : NEXT I : ? 
100 ' write 10 byte
119  LET I=BUFF:  POKE I,RSHIFT(EADR,8) : POKE I+1,EADR 
