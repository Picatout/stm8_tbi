...
64 ? "constante numerique BTOGL $500A , 32: ";
70 LET T=TICKS 
72 FOR I=1 TO 1000: BTOGL $500A , 32 : NEXT I:  ? TICKS-T " msec."
74 ? "constante symbolique BTOGL LED2 , 32: "; 
80 LET T=TICKS 
84 FOR I=1 TO 1000: BTOGL LED2 , 32 :NEXT I : ?  TICKS-T " msec." 
