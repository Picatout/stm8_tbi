...
# STM8 Tiny BASIC, notes de révision 

## Version 2.6R2_D2

* A partir de maintenant les tags de révision auront une extension dans le nom pour indiquer la révision de la documentation ainsi cette révision le tag de cette révision sera **V2.6R2_D2**.

* Création des documents markdown [notes_de_révision.md](notes_de_révision.md) et [release-notes.md](release-notes.md)

* Déplacés documents PDF dans le sous-dossier **docs**. 
...
* Ajout de l'extension Dx  aux tag de révision qui ne concernent que la documentation, on a donc pour cette révision le nom du tag sera **2.6R2D1**.

* Ajout des commandes de contrôle de servo-moteurs. 
    * **SERVO.EN** activation|désactivation de la fonction.
    * **SERVO.CH.EN** activation|désactivation d'un canal. 
    * **SERVO.POS** commande de contrôle de la position. 

* Traduction de la documentation en anglais et convertion des documents markdown au format PDF.
...
* français
  * [manuel_utilisateur.pdf](docs/manuel_utilisateur.pdf)
  * [tbi_reference_fr.pdf](docs/tbi_reference_fr.pdf)

* English
  * [user_manual.pdf](docs/user_manual.pdf)
  * [tbi_reference_en.pdf](docs/tbi_reference_en.pdf)
