...
Hexadecimal [24-Bits]
      ...
      008B45 AE A5 F4         [ 2]    1     ldw x,#kword_dict+2
...
Hexadecimal [24-Bits]
      ...
      008F5C AE A5 F2         [ 2] 3116 	ldw x,#kword_dict	
...
Hexadecimal [24-Bits]
      ...
      009911 81               [ 4] 4809 	ret
                                   ...
                                   4812 ;-----------------------
                                   4813 ; BASIC: STOP
                                   4814 ; stop progam execution  
                                   4815 ; without resetting pointers 
...
Hexadecimal [24-Bits]
      ...
      009F56 90 AE A5 F4      [ 2] 5977 	ldw y,#kword_dict+2
...
Hexadecimal [24-Bits]
                                   ...
                                   6399 ;---------------------------------
                                   6400 ; BASIC: SPIEN clkdiv, 0|1  
                                   6401 ; clkdiv -> {0..7} Fspi=Fclk/2^(n+1)
                                   6402 ; if clkdiv==-1 disable SPI
                                   6403 ; 0|1 -> disable|enable  
                                   6404 ;--------------------------------- 
                           000005  6405 SPI_CS_BIT=5
      00A1A7                       6406 spi_enable:
      00A1A7 CD 8F E8         [ 4] 6407 	call arg_list 
      00A1AA A1 02            [ 1] 6408 	cp a,#2
      00A1AC 27 03            [ 1] 6409 	jreq 1$
      00A1AE CC 87 92         [ 2] 6410 	jp syntax_error 
      00A1B1                       6411 1$: 
      00A1B1 72 12 50 C7      [ 1] 6412 	bset CLK_PCKENR1,#CLK_PCKENR1_SPI ; enable clock signal 
      00A1B5 CD 8D F1         [ 4] 6413 	call dpop 
      00A1B8 27 23            [ 1] 6414 	jreq spi_disable 
      00A1BA CD 8D F1         [ 4] 6415 	call dpop 
      00A1BD A6 08            [ 1] 6416 	ld a,#(1<<SPI_CR1_BR)
      00A1BF 42               [ 4] 6417 	mul x,a 
      00A1C0 9F               [ 1] 6418 	ld a,xl 
      00A1C1 C7 52 00         [ 1] 6419 	ld SPI_CR1,a 
                                   6420 ; configure ~CS on PE5 (D10 on CN8) as output. 
      00A1C4 72 1A 50 14      [ 1] 6421 	bset PE_ODR,#SPI_CS_BIT	; set ~CS high  
      00A1C8 72 1A 50 16      [ 1] 6422 	bset PE_DDR,#SPI_CS_BIT  ; pin as output 
                                   6423 ; configure SPI as master mode 0.	
      00A1CC 72 14 52 00      [ 1] 6424 	bset SPI_CR1,#SPI_CR1_MSTR
                                   6425 ; ~CS line controlled by sofware 	
      00A1D0 72 12 52 01      [ 1] 6426 	bset SPI_CR2,#SPI_CR2_SSM 
      00A1D4 72 10 52 01      [ 1] 6427     bset SPI_CR2,#SPI_CR2_SSI 
                                   6428 ; enable SPI
      00A1D8 72 1C 52 00      [ 1] 6429 	bset SPI_CR1,#SPI_CR1_SPE 	
      00A1DC 81               [ 4] 6430 	ret 
      00A1DD                       6431 spi_disable:
      00A1DD CD 8E 18         [ 4] 6432 	call ddrop ; throw first argument.
                                   6433 ; wait spi idle 
      00A1E0 A6 82            [ 1] 6434 1$:	ld a,#0x82 
      00A1E2 C4 52 03         [ 1] 6435 	and a,SPI_SR
      00A1E5 A1 02            [ 1] 6436 	cp a,#2 
      00A1E7 26 F7            [ 1] 6437 	jrne 1$
      00A1E9 72 1D 52 00      [ 1] 6438 	bres SPI_CR1,#SPI_CR1_SPE
      00A1ED 72 13 50 C7      [ 1] 6439 	bres CLK_PCKENR1,#CLK_PCKENR1_SPI 
      00A1F1 72 1B 50 16      [ 1] 6440 	bres PE_DDR,#SPI_CS_BIT 
      00A1F5 81               [ 4] 6441 	ret 
                                   6442 
      00A1F6                       6443 spi_clear_error:
      00A1F6 A6 78            [ 1] 6444 	ld a,#0x78 
      00A1F8 C5 52 03         [ 1] 6445 	bcp a,SPI_SR 
      00A1FB 27 04            [ 1] 6446 	jreq 1$
      00A1FD 72 5F 52 03      [ 1] 6447 	clr SPI_SR 
      00A201 81               [ 4] 6448 1$: ret 
                                   6449 
      00A202                       6450 spi_send_byte:
      00A202 88               [ 1] 6451 	push a 
      00A203 CD A1 F6         [ 4] 6452 	call spi_clear_error
      00A206 84               [ 1] 6453 	pop a 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 123.
Hexadecimal [24-Bits]



      00A207 72 03 52 03 FB   [ 2] 6454 	btjf SPI_SR,#SPI_SR_TXE,.
      00A20C C7 52 04         [ 1] 6455 	ld SPI_DR,a
      00A20F 72 01 52 03 FB   [ 2] 6456 	btjf SPI_SR,#SPI_SR_RXNE,.  
      00A214 C6 52 04         [ 1] 6457 	ld a,SPI_DR 
      00A217 81               [ 4] 6458 	ret 
                                   6459 
      00A218                       6460 spi_rcv_byte:
      00A218 A6 FF            [ 1] 6461 	ld a,#255
      00A21A 72 01 52 03 E3   [ 2] 6462 	btjf SPI_SR,#SPI_SR_RXNE,spi_send_byte 
      00A21F C6 52 04         [ 1] 6463 	ld a,SPI_DR 
      00A222 81               [ 4] 6464 	ret
                                   6465 
                                   6466 ;------------------------------
                                   6467 ; BASIC: SPIWR byte [,byte]
                                   6468 ; write 1 or more byte
                                   6469 ;------------------------------
      00A223                       6470 spi_write:
      00A223 CD 90 E8         [ 4] 6471 	call expression
      00A226 A1 04            [ 1] 6472 	cp a,#TK_INTGR 
      00A228 27 03            [ 1] 6473 	jreq 1$
      00A22A CC 87 92         [ 2] 6474 	jp syntax_error 
      00A22D                       6475 1$:	
      00A22D 9F               [ 1] 6476 	ld a,xl 
      00A22E CD A2 02         [ 4] 6477 	call spi_send_byte 
      00A231 CD 88 46         [ 4] 6478 	call next_token 
      00A234 A1 0D            [ 1] 6479 	cp a,#TK_COMMA 
      00A236 26 02            [ 1] 6480 	jrne 2$ 
      00A238 20 E9            [ 2] 6481 	jra spi_write 
      00A23A 4D               [ 1] 6482 2$:	tnz a 
      00A23B 27 05            [ 1] 6483 	jreq 3$
      00A23D 55 00 03 00 02   [ 1] 6484 	mov in,in.saved 
      00A242 81               [ 4] 6485 3$:	ret 
                                   6486 
                                   6487 
                                   6488 ;-------------------------------
                                   6489 ; BASIC: SPIRD 	
                                   6490 ; read one byte from SPI 
                                   6491 ;-------------------------------
      00A243                       6492 spi_read:
      00A243 CD A2 18         [ 4] 6493 	call spi_rcv_byte 
      00A246 5F               [ 1] 6494 	clrw x 
      00A247 97               [ 1] 6495 	ld xl,a 
      00A248 A6 04            [ 1] 6496 	ld a,#TK_INTGR 
      00A24A 81               [ 4] 6497 	ret 
                                   6498 
                                   6499 ;------------------------------
                                   6500 ; BASIC: SPISEL 0|1 
                                   6501 ; set state of ~CS line
                                   6502 ; 0|1 deselect|select  
                                   6503 ;------------------------------
      00A24B                       6504 spi_select:
      00A24B CD 88 46         [ 4] 6505 	call next_token 
      00A24E A1 04            [ 1] 6506 	cp a,#TK_INTGR 
      00A250 27 03            [ 1] 6507 	jreq 1$
      00A252 CC 87 92         [ 2] 6508 	jp syntax_error 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 124.
Hexadecimal [24-Bits]



      00A255 5D               [ 2] 6509 1$: tnzw x  
      00A256 27 05            [ 1] 6510 	jreq cs_high 
      00A258 72 1B 50 14      [ 1] 6511 	bres PE_ODR,#SPI_CS_BIT
      00A25C 81               [ 4] 6512 	ret 
      00A25D                       6513 cs_high: 
      00A25D 72 1A 50 14      [ 1] 6514 	bset PE_ODR,#SPI_CS_BIT
      00A261 81               [ 4] 6515 	ret 
                                   6516 
                                   6517 ;------------------------------
                                   6518 ;      dictionary 
                                   6519 ; format:
                                   6520 ;   link:   2 bytes 
                                   6521 ;   name_length+flags:  1 byte, bits 0:4 lenght,5:8 flags  
                                   6522 ;   cmd_name: 16 byte max 
                                   6523 ;   code_address: 2 bytes 
                                   6524 ;------------------------------
                                   6525 	.macro _dict_entry len,name,cmd 
                                   6526 	.word LINK 
                                   6527 	LINK=.
                                   6528 name:
                                   6529 	.byte len 	
                                   ...
                                   6533 
                           000000  6534 	LINK=0
                                   6535 ; respect alphabetic order for BASIC names from Z-A
                                   6536 ; this sort order is for a cleaner WORDS cmd output. 	
      00A262                       6537 kword_end:
      0021E2                       6538 	_dict_entry,5+F_IFUNC,XPEEK,xpeek 
      00A262 00 00                    1 	.word LINK 
                           0021E4     2 	LINK=.
      00A264                          3 XPEEK:
      00A264 45                       4 	.byte 5+F_IFUNC 	
      00A265 58 50 45 45 4B           5 	.ascii "XPEEK"
      00A26A 95 DB                    6 	.word xpeek 
      0021EC                       6539 	_dict_entry,3+F_IFUNC,XOR,bit_xor
      00A26C A2 64                    1 	.word LINK 
                           0021EE     2 	LINK=.
      00A26E                          3 XOR:
      00A26E 43                       4 	.byte 3+F_IFUNC 	
      00A26F 58 4F 52                 5 	.ascii "XOR"
      00A272 9E 0F                    6 	.word bit_xor 
      0021F4                       6540 	_dict_entry,5,WRITE,write  
      00A274 A2 6E                    1 	.word LINK 
                           0021F6     2 	LINK=.
      00A276                          3 WRITE:
      00A276 05                       4 	.byte 5 	
      00A277 57 52 49 54 45           5 	.ascii "WRITE"
      00A27C 9C 31                    6 	.word write 
      0021FE                       6541 	_dict_entry,5,WORDS,words 
      00A27E A2 76                    1 	.word LINK 
                           002200     2 	LINK=.
      00A280                          3 WORDS:
      00A280 05                       4 	.byte 5 	
...
Hexadecimal [24-Bits]
      ...
      00A281 57 4F 52 44 53           5 	.ascii "WORDS"
      00A286 9F 52                    6 	.word words 
      002208                       6542 	_dict_entry 4,WAIT,wait 
      00A288 A2 80                    1 	.word LINK 
                           00220A     2 	LINK=.
      00A28A                          3 WAIT:
      00A28A 04                       4 	.byte 4 	
      00A28B 57 41 49 54              5 	.ascii "WAIT"
      00A28F 95 22                    6 	.word wait 
      002211                       6543 	_dict_entry,3+F_IFUNC,USR,usr
      00A291 A2 8A                    1 	.word LINK 
                           002213     2 	LINK=.
      00A293                          3 USR:
      00A293 43                       4 	.byte 3+F_IFUNC 	
      00A294 55 53 52                 5 	.ascii "USR"
      00A297 9C E8                    6 	.word usr 
      002219                       6544 	_dict_entry,5,UNTIL,until 
      00A299 A2 93                    1 	.word LINK 
                           00221B     2 	LINK=.
      00A29B                          3 UNTIL:
      00A29B 05                       4 	.byte 5 	
      00A29C 55 4E 54 49 4C           5 	.ascii "UNTIL"
      00A2A1 A0 47                    6 	.word until 
      002223                       6545 	_dict_entry,6+F_IFUNC,UFLASH,uflash 
      00A2A3 A2 9B                    1 	.word LINK 
                           002225     2 	LINK=.
      00A2A5                          3 UFLASH:
      00A2A5 46                       4 	.byte 6+F_IFUNC 	
      00A2A6 55 46 4C 41 53 48        5 	.ascii "UFLASH"
      00A2AC 9C E2                    6 	.word uflash 
      00222E                       6546 	_dict_entry,6+F_IFUNC,UBOUND,ubound 
      00A2AE A2 A5                    1 	.word LINK 
                           002230     2 	LINK=.
      00A2B0                          3 UBOUND:
      00A2B0 46                       4 	.byte 6+F_IFUNC 	
      00A2B1 55 42 4F 55 4E 44        5 	.ascii "UBOUND"
      00A2B7 91 A7                    6 	.word ubound 
      002239                       6547 	_dict_entry,4,TONE,tone  
      00A2B9 A2 B0                    1 	.word LINK 
                           00223B     2 	LINK=.
      00A2BB                          3 TONE:
      00A2BB 04                       4 	.byte 4 	
      00A2BC 54 4F 4E 45              5 	.ascii "TONE"
      00A2C0 97 D0                    6 	.word tone 
      002242                       6548 	_dict_entry,2,TO,to
      00A2C2 A2 BB                    1 	.word LINK 
                           002244     2 	LINK=.
      00A2C4                          3 TO:
      00A2C4 02                       4 	.byte 2 	
      00A2C5 54 4F                    5 	.ascii "TO"
      00A2C7 96 39                    6 	.word to 
      002249                       6549 	_dict_entry,7+F_IFUNC,TIMEOUT,timeout 
      00A2C9 A2 C4                    1 	.word LINK 
                           00224B     2 	LINK=.
      00A2CB                          3 TIMEOUT:
...
Hexadecimal [24-Bits]
      ...
      00A2CB 47                       4 	.byte 7+F_IFUNC 	
      00A2CC 54 49 4D 45 4F 55 54     5 	.ascii "TIMEOUT"
      00A2D3 9F 9D                    6 	.word timeout 
      002255                       6550 	_dict_entry,5,TIMER,set_timer
      00A2D5 A2 CB                    1 	.word LINK 
                           002257     2 	LINK=.
      00A2D7                          3 TIMER:
      00A2D7 05                       4 	.byte 5 	
      00A2D8 54 49 4D 45 52           5 	.ascii "TIMER"
      00A2DD 9F 8C                    6 	.word set_timer 
      00225F                       6551 	_dict_entry,5+F_IFUNC,TICKS,get_ticks
      00A2DF A2 D7                    1 	.word LINK 
                           002261     2 	LINK=.
      00A2E1                          3 TICKS:
      00A2E1 45                       4 	.byte 5+F_IFUNC 	
      00A2E2 54 49 43 4B 53           5 	.ascii "TICKS"
      00A2E7 9D B7                    6 	.word get_ticks 
      002269                       6552 	_dict_entry,4,STOP,stop 
      00A2E9 A2 E1                    1 	.word LINK 
                           00226B     2 	LINK=.
      00A2EB                          3 STOP:
      00A2EB 04                       4 	.byte 4 	
      00A2EC 53 54 4F 50              5 	.ascii "STOP"
      00A2F0 99 12                    6 	.word stop 
      002272                       6553 	_dict_entry,4,STEP,step 
      00A2F2 A2 EB                    1 	.word LINK 
                           002274     2 	LINK=.
      00A2F4                          3 STEP:
      00A2F4 04                       4 	.byte 4 	
      00A2F5 53 54 45 50              5 	.ascii "STEP"
      00A2F9 96 6C                    6 	.word step 
      00227B                       6554 	_dict_entry,5,SPIWR,spi_write
      00A2FB A2 F4                    1 	.word LINK 
                           00227D     2 	LINK=.
      00A2FD                          3 SPIWR:
      00A2FD 05                       4 	.byte 5 	
      00A2FE 53 50 49 57 52           5 	.ascii "SPIWR"
      00A303 A2 23                    6 	.word spi_write 
      002285                       6555 	_dict_entry,6,SPISEL,spi_select
      00A305 A2 FD                    1 	.word LINK 
                           002287     2 	LINK=.
      00A307                          3 SPISEL:
      00A307 06                       4 	.byte 6 	
      00A308 53 50 49 53 45 4C        5 	.ascii "SPISEL"
      00A30E A2 4B                    6 	.word spi_select 
      002290                       6556 	_dict_entry,5,SPIEN,spi_enable 
      00A310 A3 07                    1 	.word LINK 
                           002292     2 	LINK=.
      00A312                          3 SPIEN:
      00A312 05                       4 	.byte 5 	
      00A313 53 50 49 45 4E           5 	.ascii "SPIEN"
      00A318 A1 A7                    6 	.word spi_enable 
      00229A                       6557 	_dict_entry,5+F_IFUNC,SPIRD, spi_read 
...
Hexadecimal [24-Bits]
      ...
      00A31C                          3 SPIRD:
      00A31C 45                       4 	.byte 5+F_IFUNC 	
      00A31D 53 50 49 52 44           5 	.ascii "SPIRD"
      00A322 A2 43                    6 	.word spi_read 
      0022A4                       6558 	_dict_entry,5,SLEEP,sleep 
      00A324 A3 1C                    1 	.word LINK 
                           0022A6     2 	LINK=.
      00A326                          3 SLEEP:
      00A326 05                       4 	.byte 5 	
      00A327 53 4C 45 45 50           5 	.ascii "SLEEP"
      00A32C 9D 50                    6 	.word sleep 
      0022AE                       6559 	_dict_entry,4+F_IFUNC,SIZE,size
      00A32E A3 26                    1 	.word LINK 
                           0022B0     2 	LINK=.
      00A330                          3 SIZE:
      00A330 44                       4 	.byte 4+F_IFUNC 	
      00A331 53 49 5A 45              5 	.ascii "SIZE"
      00A335 91 9D                    6 	.word size 
      0022B7                       6560     _dict_entry,4,SHOW,show 
      00A337 A3 30                    1 	.word LINK 
                           0022B9     2 	LINK=.
      00A339                          3 SHOW:
      00A339 04                       4 	.byte 4 	
      00A33A 53 48 4F 57              5 	.ascii "SHOW"
      00A33E 91 83                    6 	.word show 
      0022C0                       6561 	_dict_entry,4,SAVE,save
      00A340 A3 39                    1 	.word LINK 
                           0022C2     2 	LINK=.
      00A342                          3 SAVE:
      00A342 04                       4 	.byte 4 	
      00A343 53 41 56 45              5 	.ascii "SAVE"
      00A347 9A 20                    6 	.word save 
      0022C9                       6562 	_dict_entry 3,RUN,run
      00A349 A3 42                    1 	.word LINK 
                           0022CB     2 	LINK=.
      00A34B                          3 RUN:
      00A34B 03                       4 	.byte 3 	
      00A34C 52 55 4E                 5 	.ascii "RUN"
      00A34F 97 72                    6 	.word run 
      0022D1                       6563 	_dict_entry,6+F_IFUNC,RSHIFT,rshift
      00A351 A3 4B                    1 	.word LINK 
                           0022D3     2 	LINK=.
      00A353                          3 RSHIFT:
      00A353 46                       4 	.byte 6+F_IFUNC 	
      00A354 52 53 48 49 46 54        5 	.ascii "RSHIFT"
      00A35A 9E 4A                    6 	.word rshift 
      0022DC                       6564 	_dict_entry,3+F_IFUNC,RND,random 
      00A35C A3 53                    1 	.word LINK 
                           0022DE     2 	LINK=.
      00A35E                          3 RND:
      00A35E 43                       4 	.byte 3+F_IFUNC 	
      00A35F 52 4E 44                 5 	.ascii "RND"
      00A362 9E E8                    6 	.word random 
      0022E4                       6565 	_dict_entry,6,RETURN,return 
      00A364 A3 5E                    1 	.word LINK 
...
Hexadecimal [24-Bits]
      ...
      00A366                          3 RETURN:
      00A366 06                       4 	.byte 6 	
      00A367 52 45 54 55 52 4E        5 	.ascii "RETURN"
      00A36D 97 54                    6 	.word return 
      0022EF                       6566 	_dict_entry,7,RESTORE,restore 
      00A36F A3 66                    1 	.word LINK 
                           0022F1     2 	LINK=.
      00A371                          3 RESTORE:
      00A371 07                       4 	.byte 7 	
      00A372 52 45 53 54 4F 52 45     5 	.ascii "RESTORE"
      00A379 A1 02                    6 	.word restore 
      0022FB                       6567 	_dict_entry 6,REMARK,rem 
      00A37B A3 71                    1 	.word LINK 
                           0022FD     2 	LINK=.
      00A37D                          3 REMARK:
      00A37D 06                       4 	.byte 6 	
      00A37E 52 45 4D 41 52 4B        5 	.ascii "REMARK"
      00A384 95 1C                    6 	.word rem 
      002306                       6568 	_dict_entry,6,REBOOT,cold_start
      00A386 A3 7D                    1 	.word LINK 
                           002308     2 	LINK=.
      00A388                          3 REBOOT:
      00A388 06                       4 	.byte 6 	
      00A389 52 45 42 4F 4F 54        5 	.ascii "REBOOT"
      00A38F 85 54                    6 	.word cold_start 
      002311                       6569 	_dict_entry,4+F_IFUNC,READ,read  
      00A391 A3 88                    1 	.word LINK 
                           002313     2 	LINK=.
      00A393                          3 READ:
      00A393 44                       4 	.byte 4+F_IFUNC 	
      00A394 52 45 41 44              5 	.ascii "READ"
      00A398 A1 4D                    6 	.word read 
      00231A                       6570 	_dict_entry,4+F_IFUNC,QKEY,qkey  
      00A39A A3 93                    1 	.word LINK 
                           00231C     2 	LINK=.
      00A39C                          3 QKEY:
      00A39C 44                       4 	.byte 4+F_IFUNC 	
      00A39D 51 4B 45 59              5 	.ascii "QKEY"
      00A3A1 9C A4                    6 	.word qkey 
      002323                       6571 	_dict_entry,4+F_IFUNC,PRTI,const_porti 
      00A3A3 A3 9C                    1 	.word LINK 
                           002325     2 	LINK=.
      00A3A5                          3 PRTI:
      00A3A5 44                       4 	.byte 4+F_IFUNC 	
      00A3A6 50 52 54 49              5 	.ascii "PRTI"
      00A3AA A0 99                    6 	.word const_porti 
      00232C                       6572 	_dict_entry,4+F_IFUNC,PRTH,const_porth 
      00A3AC A3 A5                    1 	.word LINK 
                           00232E     2 	LINK=.
      00A3AE                          3 PRTH:
      00A3AE 44                       4 	.byte 4+F_IFUNC 	
      00A3AF 50 52 54 48              5 	.ascii "PRTH"
      00A3B3 A0 93                    6 	.word const_porth 
      002335                       6573 	_dict_entry,4+F_IFUNC,PRTG,const_portg 
...
Hexadecimal [24-Bits]
      ...
      00A3B8 50 52 54 47              5 	.ascii "PRTG"
      00A3BC A0 8D                    6 	.word const_portg 
      00233E                       6574 	_dict_entry,4+F_IFUNC,PRTF,const_portf
      00A3BE A3 B7                    1 	.word LINK 
                           002340     2 	LINK=.
      00A3C0                          3 PRTF:
      00A3C0 44                       4 	.byte 4+F_IFUNC 	
      00A3C1 50 52 54 46              5 	.ascii "PRTF"
      00A3C5 A0 87                    6 	.word const_portf 
      002347                       6575 	_dict_entry,4+F_IFUNC,PRTE,const_porte
      00A3C7 A3 C0                    1 	.word LINK 
                           002349     2 	LINK=.
      00A3C9                          3 PRTE:
      00A3C9 44                       4 	.byte 4+F_IFUNC 	
      00A3CA 50 52 54 45              5 	.ascii "PRTE"
      00A3CE A0 81                    6 	.word const_porte 
      002350                       6576 	_dict_entry,4+F_IFUNC,PRTD,const_portd
      00A3D0 A3 C9                    1 	.word LINK 
                           002352     2 	LINK=.
      00A3D2                          3 PRTD:
      00A3D2 44                       4 	.byte 4+F_IFUNC 	
      00A3D3 50 52 54 44              5 	.ascii "PRTD"
      00A3D7 A0 7B                    6 	.word const_portd 
      002359                       6577 	_dict_entry,4+F_IFUNC,PRTC,const_portc
      00A3D9 A3 D2                    1 	.word LINK 
                           00235B     2 	LINK=.
      00A3DB                          3 PRTC:
      00A3DB 44                       4 	.byte 4+F_IFUNC 	
      00A3DC 50 52 54 43              5 	.ascii "PRTC"
      00A3E0 A0 75                    6 	.word const_portc 
      002362                       6578 	_dict_entry,4+F_IFUNC,PRTB,const_portb
      00A3E2 A3 DB                    1 	.word LINK 
                           002364     2 	LINK=.
      00A3E4                          3 PRTB:
      00A3E4 44                       4 	.byte 4+F_IFUNC 	
      00A3E5 50 52 54 42              5 	.ascii "PRTB"
      00A3E9 A0 6F                    6 	.word const_portb 
      00236B                       6579 	_dict_entry,4+F_IFUNC,PRTA,const_porta 
      00A3EB A3 E4                    1 	.word LINK 
                           00236D     2 	LINK=.
      00A3ED                          3 PRTA:
      00A3ED 44                       4 	.byte 4+F_IFUNC 	
      00A3EE 50 52 54 41              5 	.ascii "PRTA"
      00A3F2 A0 69                    6 	.word const_porta 
      002374                       6580 	_dict_entry 5,PRINT,print 
      00A3F4 A3 ED                    1 	.word LINK 
                           002376     2 	LINK=.
      00A3F6                          3 PRINT:
      00A3F6 05                       4 	.byte 5 	
      00A3F7 50 52 49 4E 54           5 	.ascii "PRINT"
      00A3FC 94 2D                    6 	.word print 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 130.
Hexadecimal [24-Bits]



      00237E                       6581 	_dict_entry,4+F_IFUNC,POUT,const_output
      00A3FE A3 F6                    1 	.word LINK 
                           002380     2 	LINK=.
      00A400                          3 POUT:
      00A400 44                       4 	.byte 4+F_IFUNC 	
      00A401 50 4F 55 54              5 	.ascii "POUT"
      00A405 A0 BD                    6 	.word const_output 
      002387                       6582 	_dict_entry,4,POKE,poke 
      00A407 A4 00                    1 	.word LINK 
                           002389     2 	LINK=.
      00A409                          3 POKE:
      00A409 04                       4 	.byte 4 	
      00A40A 50 4F 4B 45              5 	.ascii "POKE"
      00A40E 95 B5                    6 	.word poke 
      002390                       6583 	_dict_entry,4+F_IFUNC,PINP,const_input
      00A410 A4 09                    1 	.word LINK 
                           002392     2 	LINK=.
      00A412                          3 PINP:
      00A412 44                       4 	.byte 4+F_IFUNC 	
      00A413 50 49 4E 50              5 	.ascii "PINP"
      00A417 A0 C3                    6 	.word const_input 
      002399                       6584 	_dict_entry,4+F_IFUNC,PEEK,peek 
      00A419 A4 12                    1 	.word LINK 
                           00239B     2 	LINK=.
      00A41B                          3 PEEK:
      00A41B 44                       4 	.byte 4+F_IFUNC 	
      00A41C 50 45 45 4B              5 	.ascii "PEEK"
      00A420 95 C8                    6 	.word peek 
      0023A2                       6585 	_dict_entry,5,PMODE,pin_mode 
      00A422 A4 1B                    1 	.word LINK 
                           0023A4     2 	LINK=.
      00A424                          3 PMODE:
      00A424 05                       4 	.byte 5 	
      00A425 50 4D 4F 44 45           5 	.ascii "PMODE"
      00A42A 9E 73                    6 	.word pin_mode 
      0023AC                       6586 	_dict_entry,5,PAUSE,pause 
      00A42C A4 24                    1 	.word LINK 
                           0023AE     2 	LINK=.
      00A42E                          3 PAUSE:
      00A42E 05                       4 	.byte 5 	
      00A42F 50 41 55 53 45           5 	.ascii "PAUSE"
      00A434 9D 5B                    6 	.word pause 
      0023B6                       6587 	_dict_entry,2+F_IFUNC,OR,bit_or
      00A436 A4 2E                    1 	.word LINK 
                           0023B8     2 	LINK=.
      00A438                          3 OR:
      00A438 42                       4 	.byte 2+F_IFUNC 	
      00A439 4F 52                    5 	.ascii "OR"
      00A43B 9D F1                    6 	.word bit_or 
      0023BD                       6588 	_dict_entry,3+F_IFUNC,ODR,const_odr 
      00A43D A4 38                    1 	.word LINK 
                           0023BF     2 	LINK=.
      00A43F                          3 ODR:
      00A43F 43                       4 	.byte 3+F_IFUNC 	
      00A440 4F 44 52                 5 	.ascii "ODR"
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 131.
Hexadecimal [24-Bits]



      00A443 A0 9F                    6 	.word const_odr 
      0023C5                       6589 	_dict_entry,3+F_IFUNC,NOT,func_not 
      00A445 A4 3F                    1 	.word LINK 
                           0023C7     2 	LINK=.
      00A447                          3 NOT:
      00A447 43                       4 	.byte 3+F_IFUNC 	
      00A448 4E 4F 54                 5 	.ascii "NOT"
      00A44B 9F AA                    6 	.word func_not 
      0023CD                       6590 	_dict_entry,3,NEW,new
      00A44D A4 47                    1 	.word LINK 
                           0023CF     2 	LINK=.
      00A44F                          3 NEW:
      00A44F 03                       4 	.byte 3 	
      00A450 4E 45 57                 5 	.ascii "NEW"
      00A453 99 5E                    6 	.word new 
      0023D5                       6591 	_dict_entry,4,NEXT,next 
      00A455 A4 4F                    1 	.word LINK 
                           0023D7     2 	LINK=.
      00A457                          3 NEXT:
      00A457 04                       4 	.byte 4 	
      00A458 4E 45 58 54              5 	.ascii "NEXT"
      00A45C 96 94                    6 	.word next 
      0023DE                       6592 	_dict_entry,6+F_IFUNC,LSHIFT,lshift
      00A45E A4 57                    1 	.word LINK 
                           0023E0     2 	LINK=.
      00A460                          3 LSHIFT:
      00A460 46                       4 	.byte 6+F_IFUNC 	
      00A461 4C 53 48 49 46 54        5 	.ascii "LSHIFT"
      00A467 9E 2D                    6 	.word lshift 
      0023E9                       6593 	_dict_entry,3+F_IFUNC,LOG,log2 
      00A469 A4 60                    1 	.word LINK 
                           0023EB     2 	LINK=.
      00A46B                          3 LOG:
      00A46B 43                       4 	.byte 3+F_IFUNC 	
      00A46C 4C 4F 47                 5 	.ascii "LOG"
      00A46F 9F F6                    6 	.word log2 
      0023F1                       6594 	_dict_entry,4,LOAD,load 
      00A471 A4 6B                    1 	.word LINK 
                           0023F3     2 	LINK=.
      00A473                          3 LOAD:
      00A473 04                       4 	.byte 4 	
      00A474 4C 4F 41 44              5 	.ascii "LOAD"
      00A478 9B 15                    6 	.word load 
      0023FA                       6595 	_dict_entry 4,LIST,list
      00A47A A4 73                    1 	.word LINK 
                           0023FC     2 	LINK=.
      00A47C                          3 LIST:
      00A47C 04                       4 	.byte 4 	
      00A47D 4C 49 53 54              5 	.ascii "LIST"
      00A481 91 F1                    6 	.word list 
      002403                       6596 	_dict_entry 3,LET,let 
      00A483 A4 7C                    1 	.word LINK 
                           002405     2 	LINK=.
      00A485                          3 LET:
      00A485 03                       4 	.byte 3 	
...
Hexadecimal [24-Bits]
      ...
      00A486 4C 45 54                 5 	.ascii "LET"
      00A489 91 C9                    6 	.word let 
      00240B                       6597 	_dict_entry,3+F_IFUNC,KEY,key 
      00A48B A4 85                    1 	.word LINK 
                           00240D     2 	LINK=.
      00A48D                          3 KEY:
      00A48D 43                       4 	.byte 3+F_IFUNC 	
      00A48E 4B 45 59                 5 	.ascii "KEY"
      00A491 9C 9C                    6 	.word key 
      002413                       6598 	_dict_entry,7,IWDGREF,refresh_iwdg
      00A493 A4 8D                    1 	.word LINK 
                           002415     2 	LINK=.
      00A495                          3 IWDGREF:
      00A495 07                       4 	.byte 7 	
      00A496 49 57 44 47 52 45 46     5 	.ascii "IWDGREF"
      00A49D 9F F1                    6 	.word refresh_iwdg 
      00241F                       6599 	_dict_entry,6,IWDGEN,enable_iwdg
      00A49F A4 95                    1 	.word LINK 
                           002421     2 	LINK=.
      00A4A1                          3 IWDGEN:
      00A4A1 06                       4 	.byte 6 	
      00A4A2 49 57 44 47 45 4E        5 	.ascii "IWDGEN"
      00A4A8 9F B9                    6 	.word enable_iwdg 
      00242A                       6600 	_dict_entry,6+F_IFUNC,INVERT,invert 
      00A4AA A4 A1                    1 	.word LINK 
                           00242C     2 	LINK=.
      00A4AC                          3 INVERT:
      00A4AC 46                       4 	.byte 6+F_IFUNC 	
      00A4AD 49 4E 56 45 52 54        5 	.ascii "INVERT"
      00A4B3 A0 2F                    6 	.word invert 
      002435                       6601 	_dict_entry,5,INPUT,input_var  
      00A4B5 A4 AC                    1 	.word LINK 
                           002437     2 	LINK=.
      00A4B7                          3 INPUT:
      00A4B7 05                       4 	.byte 5 	
      00A4B8 49 4E 50 55 54           5 	.ascii "INPUT"
      00A4BD 94 B5                    6 	.word input_var 
      00243F                       6602 	_dict_entry,2,IF,if 
      00A4BF A4 B7                    1 	.word LINK 
                           002441     2 	LINK=.
      00A4C1                          3 IF:
      00A4C1 02                       4 	.byte 2 	
      00A4C2 49 46                    5 	.ascii "IF"
      00A4C4 95 FB                    6 	.word if 
      002446                       6603 	_dict_entry,3+F_IFUNC,IDR,const_idr 
      00A4C6 A4 C1                    1 	.word LINK 
                           002448     2 	LINK=.
      00A4C8                          3 IDR:
      00A4C8 43                       4 	.byte 3+F_IFUNC 	
      00A4C9 49 44 52                 5 	.ascii "IDR"
      00A4CC A0 A5                    6 	.word const_idr 
      00244E                       6604 	_dict_entry,3,HEX,hex_base
      00A4CE A4 C8                    1 	.word LINK 
                           002450     2 	LINK=.
      00A4D0                          3 HEX:
...
Hexadecimal [24-Bits]
      ...
      00A4D0 03                       4 	.byte 3 	
      00A4D1 48 45 58                 5 	.ascii "HEX"
      00A4D4 91 93                    6 	.word hex_base 
      002456                       6605 	_dict_entry,4+F_IFUNC,GPIO,gpio 
      00A4D6 A4 D0                    1 	.word LINK 
                           002458     2 	LINK=.
      00A4D8                          3 GPIO:
      00A4D8 44                       4 	.byte 4+F_IFUNC 	
      00A4D9 47 50 49 4F              5 	.ascii "GPIO"
      00A4DD 9C AF                    6 	.word gpio 
      00245F                       6606 	_dict_entry,4,GOTO,goto 
      00A4DF A4 D8                    1 	.word LINK 
                           002461     2 	LINK=.
      00A4E1                          3 GOTO:
      00A4E1 04                       4 	.byte 4 	
      00A4E2 47 4F 54 4F              5 	.ascii "GOTO"
      00A4E6 97 19                    6 	.word goto 
      002468                       6607 	_dict_entry,5,GOSUB,gosub 
      00A4E8 A4 E1                    1 	.word LINK 
                           00246A     2 	LINK=.
      00A4EA                          3 GOSUB:
      00A4EA 05                       4 	.byte 5 	
      00A4EB 47 4F 53 55 42           5 	.ascii "GOSUB"
      00A4F0 97 34                    6 	.word gosub 
      002472                       6608 	_dict_entry,6,FORGET,forget 
      00A4F2 A4 EA                    1 	.word LINK 
                           002474     2 	LINK=.
      00A4F4                          3 FORGET:
      00A4F4 06                       4 	.byte 6 	
      00A4F5 46 4F 52 47 45 54        5 	.ascii "FORGET"
      00A4FB 9B 50                    6 	.word forget 
      00247D                       6609 	_dict_entry,3,FOR,for 
      00A4FD A4 F4                    1 	.word LINK 
                           00247F     2 	LINK=.
      00A4FF                          3 FOR:
      00A4FF 03                       4 	.byte 3 	
      00A500 46 4F 52                 5 	.ascii "FOR"
      00A503 96 0F                    6 	.word for 
      002485                       6610 	_dict_entry,4,FCPU,fcpu 
      00A505 A4 FF                    1 	.word LINK 
                           002487     2 	LINK=.
      00A507                          3 FCPU:
      00A507 04                       4 	.byte 4 	
      00A508 46 43 50 55              5 	.ascii "FCPU"
      00A50C 9E 67                    6 	.word fcpu 
      00248E                       6611 	_dict_entry,6+F_IFUNC,EEPROM,const_eeprom_base   
      00A50E A5 07                    1 	.word LINK 
                           002490     2 	LINK=.
      00A510                          3 EEPROM:
      00A510 46                       4 	.byte 6+F_IFUNC 	
      00A511 45 45 50 52 4F 4D        5 	.ascii "EEPROM"
      00A517 A0 C9                    6 	.word const_eeprom_base 
      002499                       6612 	_dict_entry,3,END,cmd_end  
      00A519 A5 10                    1 	.word LINK 
                           00249B     2 	LINK=.
...
Hexadecimal [24-Bits]
      ...
      00A51B                          3 END:
      00A51B 03                       4 	.byte 3 	
      00A51C 45 4E 44                 5 	.ascii "END"
      00A51F 97 C1                    6 	.word cmd_end 
      0024A1                       6613 	_dict_entry,6+F_CMD,DWRITE,digital_write
      00A521 A5 1B                    1 	.word LINK 
                           0024A3     2 	LINK=.
      00A523                          3 DWRITE:
      00A523 06                       4 	.byte 6+F_CMD 	
      00A524 44 57 52 49 54 45        5 	.ascii "DWRITE"
      00A52A 98 D3                    6 	.word digital_write 
      0024AC                       6614 	_dict_entry,5+F_IFUNC,DREAD,digital_read
      00A52C A5 23                    1 	.word LINK 
                           0024AE     2 	LINK=.
      00A52E                          3 DREAD:
      00A52E 45                       4 	.byte 5+F_IFUNC 	
      00A52F 44 52 45 41 44           5 	.ascii "DREAD"
      00A534 98 A1                    6 	.word digital_read 
      0024B6                       6615 	_dict_entry,2,DO,do_loop
      00A536 A5 2E                    1 	.word LINK 
                           0024B8     2 	LINK=.
      00A538                          3 DO:
      00A538 02                       4 	.byte 2 	
      00A539 44 4F                    5 	.ascii "DO"
      00A53B A0 40                    6 	.word do_loop 
      0024BD                       6616 	_dict_entry,3,DIR,directory 
      00A53D A5 38                    1 	.word LINK 
                           0024BF     2 	LINK=.
      00A53F                          3 DIR:
      00A53F 03                       4 	.byte 3 	
      00A540 44 49 52                 5 	.ascii "DIR"
      00A543 9B 9B                    6 	.word directory 
      0024C5                       6617 	_dict_entry,3,DEC,dec_base
      00A545 A5 3F                    1 	.word LINK 
                           0024C7     2 	LINK=.
      00A547                          3 DEC:
      00A547 03                       4 	.byte 3 	
      00A548 44 45 43                 5 	.ascii "DEC"
      00A54B 91 98                    6 	.word dec_base 
      0024CD                       6618 	_dict_entry,3+F_IFUNC,DDR,const_ddr 
      00A54D A5 47                    1 	.word LINK 
                           0024CF     2 	LINK=.
      00A54F                          3 DDR:
      00A54F 43                       4 	.byte 3+F_IFUNC 	
      00A550 44 44 52                 5 	.ascii "DDR"
      00A553 A0 AB                    6 	.word const_ddr 
      0024D5                       6619 	_dict_entry,6,DATALN,data_line  
      00A555 A5 4F                    1 	.word LINK 
                           0024D7     2 	LINK=.
      00A557                          3 DATALN:
      00A557 06                       4 	.byte 6 	
      00A558 44 41 54 41 4C 4E        5 	.ascii "DATALN"
      00A55E A0 D5                    6 	.word data_line 
      0024E0                       6620 	_dict_entry,4,DATA,data  
      00A560 A5 57                    1 	.word LINK 
...
Hexadecimal [24-Bits]
      ...
      00A562                          3 DATA:
      00A562 04                       4 	.byte 4 	
      00A563 44 41 54 41              5 	.ascii "DATA"
      00A567 A0 CF                    6 	.word data 
      0024E9                       6621 	_dict_entry,3+F_IFUNC,CRL,const_cr1 
      00A569 A5 62                    1 	.word LINK 
                           0024EB     2 	LINK=.
      00A56B                          3 CRL:
      00A56B 43                       4 	.byte 3+F_IFUNC 	
      00A56C 43 52 4C                 5 	.ascii "CRL"
      00A56F A0 B1                    6 	.word const_cr1 
      0024F1                       6622 	_dict_entry,3+F_IFUNC,CRH,const_cr2 
      00A571 A5 6B                    1 	.word LINK 
                           0024F3     2 	LINK=.
      00A573                          3 CRH:
      00A573 43                       4 	.byte 3+F_IFUNC 	
      00A574 43 52 48                 5 	.ascii "CRH"
      00A577 A0 B7                    6 	.word const_cr2 
      0024F9                       6623 	_dict_entry,4+F_CFUNC,CHAR,char
      00A579 A5 73                    1 	.word LINK 
                           0024FB     2 	LINK=.
      00A57B                          3 CHAR:
      00A57B 84                       4 	.byte 4+F_CFUNC 	
      00A57C 43 48 41 52              5 	.ascii "CHAR"
      00A580 9C 68                    6 	.word char 
      002502                       6624 	_dict_entry,3,BYE,bye 
      00A582 A5 7B                    1 	.word LINK 
                           002504     2 	LINK=.
      00A584                          3 BYE:
      00A584 03                       4 	.byte 3 	
      00A585 42 59 45                 5 	.ascii "BYE"
      00A588 9D 06                    6 	.word bye 
      00250A                       6625 	_dict_entry,5,BTOGL,bit_toggle
      00A58A A5 84                    1 	.word LINK 
                           00250C     2 	LINK=.
      00A58C                          3 BTOGL:
      00A58C 05                       4 	.byte 5 	
      00A58D 42 54 4F 47 4C           5 	.ascii "BTOGL"
      00A592 95 76                    6 	.word bit_toggle 
      002514                       6626 	_dict_entry,5+F_IFUNC,BTEST,bit_test 
      00A594 A5 8C                    1 	.word LINK 
                           002516     2 	LINK=.
      00A596                          3 BTEST:
      00A596 45                       4 	.byte 5+F_IFUNC 	
      00A597 42 54 45 53 54           5 	.ascii "BTEST"
      00A59C 95 8A                    6 	.word bit_test 
      00251E                       6627 	_dict_entry,4,BSET,bit_set 
      00A59E A5 96                    1 	.word LINK 
                           002520     2 	LINK=.
      00A5A0                          3 BSET:
      00A5A0 04                       4 	.byte 4 	
      00A5A1 42 53 45 54              5 	.ascii "BSET"
      00A5A5 95 4D                    6 	.word bit_set 
      002527                       6628 	_dict_entry,4,BRES,bit_reset
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 136.
Hexadecimal [24-Bits]



      00A5A7 A5 A0                    1 	.word LINK 
                           002529     2 	LINK=.
      00A5A9                          3 BRES:
      00A5A9 04                       4 	.byte 4 	
      00A5AA 42 52 45 53              5 	.ascii "BRES"
      00A5AE 95 61                    6 	.word bit_reset 
      002530                       6629 	_dict_entry,3+F_IFUNC,BIT,bitmask
      00A5B0 A5 A9                    1 	.word LINK 
                           002532     2 	LINK=.
      00A5B2                          3 BIT:
      00A5B2 43                       4 	.byte 3+F_IFUNC 	
      00A5B3 42 49 54                 5 	.ascii "BIT"
      00A5B6 A0 13                    6 	.word bitmask 
      002538                       6630 	_dict_entry,3,AWU,awu 
      00A5B8 A5 B2                    1 	.word LINK 
                           00253A     2 	LINK=.
      00A5BA                          3 AWU:
      00A5BA 03                       4 	.byte 3 	
      00A5BB 41 57 55                 5 	.ascii "AWU"
      00A5BE 9D 6E                    6 	.word awu 
      002540                       6631 	_dict_entry,7,AUTORUN,autorun
      00A5C0 A5 BA                    1 	.word LINK 
                           002542     2 	LINK=.
      00A5C2                          3 AUTORUN:
      00A5C2 07                       4 	.byte 7 	
      00A5C3 41 55 54 4F 52 55 4E     5 	.ascii "AUTORUN"
      00A5CA 9D 0F                    6 	.word autorun 
      00254C                       6632 	_dict_entry,3+F_IFUNC,ASC,ascii
      00A5CC A5 C2                    1 	.word LINK 
                           00254E     2 	LINK=.
      00A5CE                          3 ASC:
      00A5CE 43                       4 	.byte 3+F_IFUNC 	
      00A5CF 41 53 43                 5 	.ascii "ASC"
      00A5D2 9C 7C                    6 	.word ascii 
      002554                       6633 	_dict_entry,3+F_IFUNC,AND,bit_and
      00A5D4 A5 CE                    1 	.word LINK 
                           002556     2 	LINK=.
      00A5D6                          3 AND:
      00A5D6 43                       4 	.byte 3+F_IFUNC 	
      00A5D7 41 4E 44                 5 	.ascii "AND"
      00A5DA 9D D3                    6 	.word bit_and 
      00255C                       6634 	_dict_entry,7+F_IFUNC,ADCREAD,analog_read
      00A5DC A5 D6                    1 	.word LINK 
                           00255E     2 	LINK=.
      00A5DE                          3 ADCREAD:
      00A5DE 47                       4 	.byte 7+F_IFUNC 	
      00A5DF 41 44 43 52 45 41 44     5 	.ascii "ADCREAD"
      00A5E6 98 6B                    6 	.word analog_read 
      002568                       6635 	_dict_entry,5,ADCON,power_adc 
      00A5E8 A5 DE                    1 	.word LINK 
                           00256A     2 	LINK=.
      00A5EA                          3 ADCON:
      00A5EA 05                       4 	.byte 5 	
      00A5EB 41 44 43 4F 4E           5 	.ascii "ADCON"
      00A5F0 98 1E                    6 	.word power_adc 
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 137.
Hexadecimal [24-Bits]



      00A5F2                       6636 kword_dict:
      002572                       6637 	_dict_entry,3+F_IFUNC,ABS,abs
      00A5F2 A5 EA                    1 	.word LINK 
                           002574     2 	LINK=.
      00A5F4                          3 ABS:
      00A5F4 43                       4 	.byte 3+F_IFUNC 	
      00A5F5 41 42 53                 5 	.ascii "ABS"
      00A5F8 9D BD                    6 	.word abs 
                                   6638 	
                                   6639 
      00A600                       6640 	.bndry 128 ; align on FLASH block.
                                   6641 ; free space for user application  
      00A600                       6642 user_space:
                                   6643 ; USR() function test
      00A600 89               [ 2] 6644 	pushw x 
      00A601 72 1A 50 0A      [ 1] 6645 	bset PC_ODR,#5 
      00A605 85               [ 2] 6646 	popw x 
      00A606 CD 9D 65         [ 4] 6647 	call pause02 
      00A609 72 1B 50 0A      [ 1] 6648 	bres PC_ODR,#5 
      00A60D 81               [ 4] 6649 	ret
                                   6650 
                                   6651 	.area FLASH_DRIVE (ABS)
      010000                       6652 	.org 0x10000
      010000                       6653 fdrive:
                                   6654 ;.byte 0,0,0,0
...
Symbol Table
    ...
    .__.H$L.=  000001 L   |   5 ABS        002574 R   |   5 ADCON      00256A R
  5 ADCREAD    00255E R   |     ADC_CR1 =  005401     |     ADC_CR1_=  000000 
    ...
    AFR7_BEE=  000007     |   5 AND        002556 R   |     ARG_CNT =  000001 
    ARG_OFS =  000002     |   5 ASC        00254E R   |     ATTRIB  =  000002 
  5 AUTORUN    002542 R   |     AUTORUN_=  004000     |   5 AWU        00253A R
  5 AWUHandl   000001 R   |     AWU_APR =  0050F1     |     AWU_CSR =  0050F0 
    ...
    BINARY  =  000001     |   5 BIT        002532 R   |     BIT0    =  000000 
    BIT1    =  000001     |     BIT2    =  000002     |     BIT3    =  000003 
    BIT4    =  000004     |     BIT5    =  000005     |     BIT6    =  000006 
    BIT7    =  000007     |     BLOCK_SI=  000080     |     BOOT_ROM=  006000 
    BOOT_ROM=  007FFF     |     BPTR    =  000005     |   5 BRES       002529 R
  5 BSET       002520 R   |     BSIZE   =  000001     |     BSP     =  000008 
  5 BTEST      002516 R   |   5 BTOGL      00250C R   |     BTW     =  000001 
    BUFIDX  =  000003     |   5 BYE        002504 R   |     C       =  000001 
    ...
    CFG_GCR_=  000001     |     CFG_GCR_=  000000     |   5 CHAR       0024FB R
...
Symbol Table
    ...
    CR      =  00000D     |   5 CRH        0024F3 R   |   5 CRL        0024EB R
    ...
    CURR    =  000002     |     CX_BPTR =  000001     |     CX_CNT  =  000004 
    CX_IN   =  000003     |   5 DATA       0024E2 R   |   5 DATALN     0024D7 R
    DBG_A   =  000005     |     DBG_CC  =  000006     |     DBG_X   =  000003 
    DBG_Y   =  000001     |   5 DDR        0024CF R   |     DEBUG   =  000000 
    DEBUG_BA=  007F00     |     DEBUG_EN=  007FFF     |   5 DEC        0024C7 R
    DEST    =  000001     |     DEVID_BA=  0048CD     |     DEVID_EN=  0048D8 
    DEVID_LO=  0048D2     |     DEVID_LO=  0048D3     |     DEVID_LO=  0048D4 
    DEVID_LO=  0048D5     |     DEVID_LO=  0048D6     |     DEVID_LO=  0048D7 
    DEVID_LO=  0048D8     |     DEVID_WA=  0048D1     |     DEVID_XH=  0048CE 
    DEVID_XL=  0048CD     |     DEVID_YH=  0048D0     |     DEVID_YL=  0048CF 
  5 DIR        0024BF R   |     DIVIDND =  000007     |     DIVISR  =  000005 
    DM_BK1RE=  007F90     |     DM_BK1RH=  007F91     |     DM_BK1RL=  007F92 
    DM_BK2RE=  007F93     |     DM_BK2RH=  007F94     |     DM_BK2RL=  007F95 
    DM_CR1  =  007F96     |     DM_CR2  =  007F97     |     DM_CSR1 =  007F98 
    DM_CSR2 =  007F99     |     DM_ENFCT=  007F9A     |   5 DO         0024B8 R
  5 DREAD      0024AE R   |     DSTACK_S=  000020     |   5 DWRITE     0024A3 R
  5 EEPROM     002490 R   |     EEPROM_B=  004000     |     EEPROM_E=  0047FF 
    EEPROM_S=  000800     |   5 END        00249B R   |     EOF     =  0000FF 
  ...
  5 FCPU       002487 R   |     FF      =  00000C     |     FHSE    =  7A1200 
...
Symbol Table
    ...
    FLOOP   =  000002     |     FLSI    =  01F400     |   5 FOR        00247F R
  5 FORGET     002474 R   |     FRUN    =  000000     |     FSIZE   =  000001 
    FSLEEP  =  000003     |     FTRAP   =  000001     |     F_CFUNC =  000080 
    F_CMD   =  000000     |     F_CONST =  0000C0     |     F_IFUNC =  000040 
  5 GOSUB      00246A R   |   5 GOTO       002461 R   |   5 GPIO       002458 R
    GPIO_BAS=  005000     |     GPIO_CR1=  000003     |     GPIO_CR2=  000004 
    GPIO_DDR=  000002     |     GPIO_IDR=  000001     |     GPIO_ODR=  000000 
    GPIO_SIZ=  000005     |   5 HEX        002450 R   |     HSECNT  =  004809 
  ...
  5 IDR        002448 R   |   5 IF         002441 R   |     IN      =  000005 
    INCR    =  000001     |     INP     =  000000     |   5 INPUT      002437 R
...
Symbol Table
    ...
    INT_VECT=  00805C     |     INT_VECT=  008058     |   5 INVERT     00242C R
    INW     =  000003     |     ITC_SPR1=  007F70     |     ITC_SPR2=  007F71 
    ITC_SPR3=  007F72     |     ITC_SPR4=  007F73     |     ITC_SPR5=  007F74 
    ITC_SPR6=  007F75     |     ITC_SPR7=  007F76     |     ITC_SPR8=  007F77 
  5 IWDGEN     002421 R   |   5 IWDGREF    002415 R   |     IWDG_KEY=  000055 
    IWDG_KEY=  0000CC     |     IWDG_KEY=  0000AA     |     IWDG_KR =  0050E0 
    IWDG_PR =  0050E1     |     IWDG_RLR=  0050E2     |   5 KEY        00240D R
    LAST    =  000003     |     LB      =  000002     |     LED2_BIT=  000005 
    LED2_MAS=  000020     |     LED2_POR=  00500A     |     LEN     =  000005 
  5 LET        002405 R   |     LINENO  =  000005     |   5 LINK    =  002574 R
  5 LIST       0023FC R   |     LL      =  000002     |     LLEN    =  000002 
    LL_HB   =  000001     |     LN_PTR  =  000005     |   5 LOAD       0023F3 R
  5 LOG        0023EB R   |   5 LSHIFT     0023E0 R   |     MAJOR   =  000001 
  ...
  5 NEXT       0023D7 R   |     NFLASH_W=  00480E     |     NHSECNT =  00480A 
    ...
    NOPTBL  =  00487F     |   5 NOT        0023C7 R   |     NUBC    =  004802 
    NWDGOPT =  004806     |     NWDGOPT_=  FFFFFFFD     |     NWDGOPT_=  FFFFFFFC 
    NWDGOPT_=  FFFFFFFF     |     NWDGOPT_=  FFFFFFFE     |   5 NonHandl   000000 R
  5 ODR        0023BF R   |     OP      =  000005     |     OPT     =  000002 
  ...
  5 OR         0023B8 R   |     OUTP    =  000001     |     OUTPUT_F=  000001 
    ...
    PAD_SIZE=  000028     |   5 PAUSE      0023AE R   |     PA_BASE =  005000 
...
Symbol Table
  ...
  5 POKE       002389 R   |   5 POUT       002380 R   |     PREV    =  000001 
  5 PRINT      002376 R   |     PROD    =  000002     |   5 PRTA       00236D R
  5 PRTB       002364 R   |   5 PRTC       00235B R   |   5 PRTD       002352 R
  5 PRTE       002349 R   |   5 PRTF       002340 R   |   5 PRTG       002337 R
  5 PRTH       00232E R   |   5 PRTI       002325 R   |   5 QKEY       00231C R
    RAM_BASE=  000000     |     RAM_END =  0017FF     |     RAM_SIZE=  001800 
  5 READ       002313 R   |   5 REBOOT     002308 R   |     RELOP   =  000005 
  5 REMARK     0022FD R   |   5 RESTORE    0022F1 R   |     RETL1   =  000001 
  5 RETURN     0022E6 R   |     RET_ADDR=  000003     |     RET_INW =  000005 
  5 RND        0022DE R   |     ROP     =  004800     |   5 RSHIFT     0022D3 R
  ...
  5 SAVE       0022C2 R   |     SDIVD   =  000002     |     SFR_BASE=  005000 
    ...
    SIGN    =  000001     |   5 SIZE       0022B0 R   |     SKIP    =  000005 
  5 SLEEP      0022A6 R   |     SPACE   =  000020     |   5 SPIEN      002292 R
  ...
  5 STEP       002274 R   |   5 STOP       00226B R   |     SWIM_CSR=  007F80 
    TAB     =  000009     |     TAB_WIDT=  000004     |     TCHAR   =  000001 
    TEMP    =  000003     |     TIB_SIZE=  000050     |     TICK    =  000027 
  5 TICKS      002261 R   |     TIM1_ARR=  005262     |     TIM1_ARR=  005263 
...
Symbol Table
    ...
    TIM4_SR =  005342     |     TIM4_SR_=  000000     |   5 TIMEOUT    00224B R
  5 TIMER      002257 R   |     TIM_CR1_=  000007     |     TIM_CR1_=  000000 
  ...
  5 TO         002244 R   |   5 TONE       00223B R   |   5 Timer4Up   000026 R
  ...
  5 UBOUND     002230 R   |   5 UBTN_Han   000069 R   |   5 UFLASH     002225 R
  5 UNTIL      00221B R   |   5 USER_ABO   000071 R   |     USE_BLOC=  000000 
  5 USR        002213 R   |     USR_BTN_=  000004     |     USR_BTN_=  000010 
    USR_BTN_=  005015     |   5 Uart1RxH   00000F R   |   5 UserButt   00003C R
...
Symbol Table
  ...
  5 WAIT       00220A R   |     WDGOPT  =  004805     |     WDGOPT_I=  000002 
    WDGOPT_L=  000003     |     WDGOPT_W=  000000     |     WDGOPT_W=  000001 
    WIDTH   =  000001     |     WIDTH_SA=  000002     |     WLEN    =  000001 
  5 WORDS      002200 R   |   5 WRITE      0021F6 R   |     WWDG_CR =  0050D1 
    WWDG_WR =  0050D2     |     XADR    =  000001     |     XMASK   =  000001 
  5 XOR        0021EE R   |   5 XPEEK      0021E4 R   |     XSAVE   =  000005 
    YSAVE   =  000003     |   5 abs        001D3D R   |   1 acc16      00000C R
  1 acc24      00000B R   |   1 acc8       00000D R   |   5 accept_c   0009B9 R
  5 add        000E29 R   |   5 analog_r   0017EB R   |   5 ansi_seq   00097B R
  5 arduino_   001E48 R   |   5 arg_list   000F68 R   |   1 array_si   000023 R
  5 ascii      001BFC R   |   5 at_tst     000B8C R   |   5 atoi24     000C9F R
  5 atoi_exi   000D0D R   |   5 autorun    001C8F R   |   5 autorun_   0005C7 R
  5 awu        001CEE R   |   5 awu02      001CF8 R   |   5 bad_port   001C5D R
  1 base       00000A R   |   1 basicptr   000004 R   |   5 beep       00175A R
  5 bin_exit   000A90 R   |   5 bit_and    001D53 R   |   5 bit_or     001D71 R
  5 bit_rese   0014E1 R   |   5 bit_set    0014CD R   |   5 bit_test   00150A R
  5 bit_togg   0014F6 R   |   5 bit_xor    001D8F R   |   5 bitmask    001F93 R
  5 bkslsh_t   000B37 R   |   5 bksp       0001D0 R   |   5 break_po   0018C0 R
  5 bye        001C86 R   |   5 char       001BE8 R   |   5 check_fu   000365 R
  5 clear_ba   0005DC R   |   5 clear_va   00046F R   |   5 clock_in   00008C R
  5 cmd_end    001741 R   |   5 cmd_line   000784 R   |   5 cmd_name   000ED4 R
  5 cmp_name   001934 R   |   5 cold_sta   0004D4 R   |   5 colon_ts   000B60 R
  5 comma_ts   000B6B R   |   5 compile    000374 R   |   5 const_cr   002031 R
  5 const_cr   002037 R   |   5 const_dd   00202B R   |   5 const_ee   002049 R
  5 const_id   002025 R   |   5 const_in   002043 R   |   5 const_od   00201F R
  5 const_ou   00203D R   |   5 const_po   001FE9 R   |   5 const_po   001FEF R
  5 const_po   001FF5 R   |   5 const_po   001FFB R   |   5 const_po   002001 R
  5 const_po   002007 R   |   5 const_po   00200D R   |   5 const_po   002013 R
  5 const_po   002019 R   |   5 convert_   000A18 R   |   1 count      000003 R
  5 cp_loop    000F17 R   |   5 create_g   0002C4 R   |   5 cs_high    0021DD R
  5 cstk_pro   000DF2 R   |   5 dash_tst   000B81 R   |   5 data       00204F R
  1 data_len   000009 R   |   5 data_lin   002055 R   |   1 data_ofs   000008 R
  1 data_ptr   000006 R   |   5 data_sea   002095 R   |   5 ddrop      000D98 R
  5 ddrop_n    000DB5 R   |   5 ddup       000DA1 R   |   5 dec_base   001118 R
  5 del_back   0009AA R   |   5 del_line   00028C R   |   5 del_ln     00099B R
  5 delete     0001E0 R   |   5 digital_   001821 R   |   5 digital_   001853 R
  5 dir_loop   001B27 R   |   5 director   001B1B R   |   5 divide     000E7F R
  5 divu24_8   000908 R   |   5 do_loop    001FC0 R   |   5 dotr       000DFC R
  5 dotr_loo   000E11 R   |   5 dots       000DC8 R   |   5 dpick      000DA1 R
  5 dpop       000D71 R   |   5 dpush      000D64 R   |   5 drive_fr   001BA4 R
  3 dstack     001760 R   |   3 dstack_e   001780 R   |   5 dstk_pro   000DBE R
  1 dstkptr    00001C R   |   5 dswap      000D7E R   |   5 enable_i   001F39 R
  5 eql_tst    000BEC R   |   5 equal      0013A0 R   |   5 err_bad_   0006BB R
  5 err_cmd_   00067C R   |   5 err_div0   00063E R   |   5 err_dupl   000697 R
  5 err_math   000624 R   |   5 err_mem_   000607 R   |   5 err_msg    0005ED R
  5 err_no_a   0006C8 R   |   5 err_no_d   0006FC R   |   5 err_no_l   00064E R
  5 err_not_   0006A9 R   |   5 err_run_   000665 R   |   5 err_synt   000615 R
  5 escaped    000A2D R   |   5 expect     000F5B R   |   5 expr_exi   0010A9 R
  5 expressi   001068 R   |   5 factor     000FC3 R   |   1 farptr     000016 R
  5 fcpu       001DE7 R   |   7 fdrive     010000 R   |   5 fetch      000DA1 R
  1 ffree      000019 R   |   5 file_cou   001B9C R   |   5 final_te   000975 R
  5 first_li   00119C R   |   1 flags      000025 R   |   5 for        00158F R
  5 forget     001AD0 R   |   1 free_ram   00005C R   |   5 func_arg   000F8C R
  5 func_not   001F2A R   |   5 ge         0013A2 R   |   5 get_arra   000F9C R
  5 get_targ   001683 R   |   5 get_tick   001D37 R   |   5 get_toke   000AD2 R
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 146.
Hexadecimal [24-Bits]

Symbol Table

  5 getc       0001BC R   |   5 gosub      0016B4 R   |   5 goto       001699 R
  5 gpio       001C2F R   |   5 gt         00139E R   |   5 gt_tst     000BF7 R
  5 hex_base   001113 R   |   5 if         00157B R   |   1 in         000001 R
  1 in.saved   000002 R   |   1 in.w       000000 R   |   5 incr_far   0018E9 R
  5 input_ex   001499 R   |   5 input_lo   001437 R   |   5 input_va   001435 R
  5 insert_l   0002FD R   |   5 insert_l   000362 R   |   5 interp     000758 R
  5 interp_l   000798 R   |   5 invert     001FAF R   |   5 is_alpha   00047D R
  5 is_digit   000C8A R   |   5 itoa       0008C1 R   |   5 itoa_loo   0008D9 R
  5 jp_to_ta   0016A7 R   |   5 key        001C1C R   |   5 kword_di   002572 R
  5 kword_en   0021E2 R   |   5 last_lin   0011A5 R   |   5 le         0013A7 R
  5 leading_   001F83 R   |   5 left_arr   00097B R   |   5 let        001149 R
  5 let02      001153 R   |   5 lines_sk   0011AA R   |   5 list       001171 R
  5 list_exi   0011F3 R   |   5 list_sta   0011CD R   |   5 load       001A95 R
  5 load_aut   0005A3 R   |   5 load_fil   001A64 R   |   5 log2       001F76 R
  5 logical_   001F20 R   |   5 loop_bac   00165C R   |   1 loop_dep   000022 R
  5 loop_don   001671 R   |   5 lshift     001DAD R   |   5 lt         0013A5 R
  5 lt_tst     000C30 R   |   5 modulo     000EC3 R   |   5 move       000226 R
  5 move_dow   000244 R   |   5 move_exi   000265 R   |   5 move_loo   000249 R
  5 move_up    000236 R   |   5 mul_char   00138F R   |   5 multiply   000E37 R
  5 mulu24_8   000D11 R   |   5 nbr_tst    000B0D R   |   5 ne         0013AA R
  5 neg_acc2   000930 R   |   5 new        0018DE R   |   5 next       001614 R
  5 next_tok   0007C6 R   |   5 no_match   000F29 R   |   5 none       000AD2 R
  5 other      000C68 R   |   3 pad        001738 R   |   5 parse_bi   000A70 R
  5 parse_in   000A35 R   |   5 parse_ke   000A98 R   |   5 parse_qu   0009DD R
  5 pause      001CDB R   |   5 pause02    001CE5 R   |   5 peek       001548 R
  5 pin_mode   001DF3 R   |   5 plus_tst   000BC0 R   |   5 poke       001535 R
  5 power_ad   00179E R   |   5 prcnt_ts   000BE1 R   |   5 print      0013AD R
  5 print_ex   001409 R   |   5 print_in   000863 R   |   5 prt_basi   001246 R
  5 prt_cmd_   0011F6 R   |   5 prt_loop   0013B1 R   |   5 prt_quot   00120A R
  5 prti24     00081B R   |   1 ptr16      000017 R   |   1 ptr8       000018 R
  5 putc       0001B3 R   |   5 puts       0001C6 R   |   5 qkey       001C24 R
  5 qmark_ts   000B97 R   |   5 random     001E68 R   |   5 read       0020CD R
  5 read01     0020CF R   |   5 readln     000953 R   |   5 readln_l   000959 R
  5 readln_q   0009CE R   |   5 refresh_   001F71 R   |   5 rel_exit   001100 R
  5 relation   0010AC R   |   5 relop_st   001392 R   |   5 rem        00149C R
  5 reprint    00097B R   |   5 reset_co   0013AF R   |   5 rest_con   001425 R
  5 restore    002082 R   |   5 return     0016D4 R   |   5 right_ar   00097B R
  5 rparnt_t   000B55 R   |   5 rshift     001DCA R   |   5 run        0016F2 R
  5 run_it     00171A R   |   1 rx_char    000027 R   |   5 save       0019A0 R
  5 save_con   001415 R   |   5 search_d   000F06 R   |   5 search_e   000F57 R
  5 search_f   001955 R   |   5 search_l   000268 R   |   5 search_l   000270 R
  5 search_n   000F0A R   |   1 seedx      000012 R   |   1 seedy      000014 R
  5 seek_fdr   0018F7 R   |   5 select_p   001E38 R   |   5 set_time   001F0C R
  5 sharp_ts   000B76 R   |   5 show       001103 R   |   5 single_c   00138B R
  5 size       00111D R   |   5 skip       000D4B R   |   5 slash_ts   000BD6 R
  5 sleep      001CD0 R   |   5 software   00048E R   |   5 spaces     0001EE R
  5 spi_clea   002176 R   |   5 spi_disa   00215D R   |   5 spi_enab   002127 R
  5 spi_rcv_   002198 R   |   5 spi_read   0021C3 R   |   5 spi_sele   0021CB R
  5 spi_send   002182 R   |   5 spi_writ   0021A3 R   |   3 stack_fu   001780 R
  3 stack_un   001800 R   |   5 star_tst   000BCB R   |   5 step       0015EC R
  5 stop       001892 R   |   5 store      000DAB R   |   5 store_lo   001601 R
  5 str_matc   000F38 R   |   5 str_tst    000AFC R   |   5 strcmp     000207 R
  5 strcpy     000218 R   |   5 strlen     0001FA R   |   5 substrac   000E31 R
  5 syntax_e   000712 R   |   1 tab_widt   000026 R   |   5 tb_error   000714 R
  5 term       00101B R   |   5 term01     001024 R   |   5 term_exi   001065 R
ASxxxx Assembler V02.00 + NoICE + SDCC mods  (STMicroelectronics STM8), page 147.
Hexadecimal [24-Bits]

Symbol Table

  3 tib        0016E8 R   |   5 tick_tst   000BAE R   |   1 ticks      00000E R
  5 timeout    001F1D R   |   1 timer      000010 R   |   5 timer2_i   0000A2 R
  5 timer4_i   0000AF R   |   5 to         0015B9 R   |   5 to_upper   000C93 GR
  5 token_ch   000C77 R   |   5 token_ex   000C87 R   |   5 tone       001750 R
  5 try_next   0020BD R   |   1 txtbgn     00001E R   |   1 txtend     000020 R
  5 uart1_in   000178 R   |   5 uart1_se   000188 R   |   5 ubound     001127 R
  5 uflash     001C62 R   |   5 unget_to   000D5E R   |   5 unlock_e   0000C4 R
  5 unlock_f   0000D2 R   |   5 until      001FC7 R   |   5 user_int   00004F R
  5 user_spa   002580 R   |   5 usr        001C68 R   |   1 vars       000028 R
  5 wait       0014A2 R   |   5 warm_ini   000586 R   |   5 warm_sta   000755 R
  5 words      001ED2 R   |   5 write      001BB1 R   |   5 write_bl   000155 R
  5 write_by   0000E0 R   |   5 write_ee   00011C R   |   5 write_ex   000150 R
  5 write_fl   000106 R   |   5 xpeek      00155B R
